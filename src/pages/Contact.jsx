...
const INFO_ITEMS = [
  ...
  },
  {
    ...
    label: 'Localisation',
    value: 'Grand-Est & toute la France',
  },
  {
...
export default function Contact() {
  useSEO({
    ...
    description: 'Demandez votre audit IA gratuit ou renseignez-vous sur nos formations CPF/OPCO et solutions IA sur mesure dans le Grand-Est. Réponse sous 24h.',
    path: '/contact',
    jsonLd: FAQ_SCHEMA,
  })
